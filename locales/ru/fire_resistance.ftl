...
compression_element_result-text =
    Коэффициент снижения предела текучести стали <blockquote>{ $gamma_t }</blockquote>
    Коэффициент снижения модуля упругости стали <blockquote>{ $gamma_elasticity }</blockquote>
    Критическая температура стального элемента конструкции
    <blockquote>{ $t_critic } ℃</blockquote>
stretch_or_bend_element_result-text =
    Коэффициент снижения предела текучести стали <blockquote>{ $gamma }</blockquote>
    Критическая температура стального элемента конструкции
    <blockquote>{ $t_critic } ℃</blockquote>
