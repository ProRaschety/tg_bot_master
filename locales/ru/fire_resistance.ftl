...
thermal_calculation-text = Предел огнестойкости незащищенного стального элемента конструкции <blockquote>{ $time_fsr } мин</blockquote>
